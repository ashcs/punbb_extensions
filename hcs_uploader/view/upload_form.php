...
<div class="form-group attach" style="display:none">
		...
		data-jfiler-maxSize="<?php echo App::$forum_config['uploader_max_file_size'] * App::$forum_config['uploader_max_upload_once'] ?>"
		data-jfiler-uploadUrl="<?php echo $upload_url ?>" 
		data-jfiler-uploadData='{"csrf_token": "<?php echo $upload_token ?>", "form_sent": 1, "resource_name": "<?= $resource_name ?>", "sign":"<?= $sign ?>"}' >
</div>
