...
<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
	...
	<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
	    <div class="sf-box text">
	        ...
	        <span class="fld-input"><input type="text" id="fld<?php echo $forum_page['fld_count'] ?>" name="form[ulogin_id]" size="40" maxlength="50" value="<?php echo forum_htmlencode($forum_config['o_ulogin_id']) ?>" /></span>
	    </div>		
	</div>
	...
	<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
	    <div class="sf-box checkbox">
	        <span class="fld-input">
	            <input id="fld<?php echo ++$forum_page['fld_count'] ?>" type="checkbox" <?php if ($forum_config['o_ulogin_force_reg'] == '1') echo ' checked="checked"' ?> value="1" name="form[ulogin_force_reg]">
	        </span>
